...
public class TravelocityHomePage {
	...
	public static final Target BOTON_BUSCAR_VUELO = Target.the("Boton buscar vuelos").located(By.xpath("//form[@id='gcw-flights-form-hp-flight']//button[@data-gcw-change-submit-text='Search']"));
}
